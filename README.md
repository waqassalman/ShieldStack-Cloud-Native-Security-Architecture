...
| Diagram | Description |
|---------|-------------|
| [`Network_Architecture_Diagram.png`](diagrams/Network_Architecture_Diagram.png) | Full network topology with zones, firewalls, and gateways |
| [`Data_Flow_Diagram.png`](diagrams/Data_Flow_Diagram.png) | Data flow across customer, web, app, database, and payment processor |
